...
import {MissingData} from "../missing";
            ...
            return (
              <section key={index} className="flex gap-2 items-center border bg-white p-1 cursor-pointer">
                <div className="border w-[5rem]">
                  {/* <img className="" src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" /> */}
                ...
                <article className="leading-tight">
                  ...
                  <p>Last seen: <span>{item.lastSeen}</span></p>
